...
Proof.
intros. destruct x. destruct y. try reflexivity.
simpl. reflexivity. simpl. Search (negb _ || _). rewrite orb_negb_l. 
reflexivity.
Qed.
(*Zad 1b*)
...
Proof.
intros. destruct x,y,z. try simpl. reflexivity.
 simpl. reflexivity. simpl. reflexivity. simpl. reflexivity. simpl. reflexivity. now reflexivity.
now reflexivity. reflexivity.
Qed.
